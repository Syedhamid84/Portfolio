...
const Topbar = () => {
  ...
  return (
    ...
    <div id="test2" className=" ">
          ...
          return (
            <div key={index} className="hidden md:flex">
              <Link
                ...
                offset={-50}
                duration={500}
                className="hover:border-b-2 border-blue font-semibold hover:text-blue pb-1.5 cursor-pointer font-poppins shadow-2xl space-links"
              >
                {item.name}
              </Link>
            </div>
      ...
      {open && <MobileNavbar handleMenuClick={handleMenuClick} />}
    </div>
  );
};
