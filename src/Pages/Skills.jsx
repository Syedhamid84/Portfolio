...
const Skills = () => {
  return (
    <section id="skills" className="h-[990px] w-full bg-[#5304b5]">
      ...
      <div className="flex justify-center ">
        <div className="flex justify-center pb-4 gap-3 bg-[#330572] flex-wrap rounded-lg mx-48 pt-4 mb-4">
          {SkillsData.map((item, index) => {
            return (
              <div
                className="flex flex-col justify-center items-center h-32 w-40 bg-[#05011f] rounded-lg"
                key={index}
              >
                <img
                  src={item.image}
                  alt=""
                  className="h-12 w-12 bg-[#05011f] "
                />
                <span className="text-2xl text-[#FFFFFF] mt-2">
                  {item.name}
                </span>
              </div>
            );
