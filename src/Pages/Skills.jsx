...
const Skills = () => {
  return (
    <>
      <section className="min-h-screen w-full bg-[#5304b5]">
        ...
        <div className="flex justify-center min-h-screen ">
            <div className="flex justify-center h-screen w-screen gap-3 bg-[#330572] flex-wrap rounded-lg mx-48 pt-4 mb-4">
